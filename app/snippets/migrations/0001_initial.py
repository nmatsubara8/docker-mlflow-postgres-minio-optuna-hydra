    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('commented_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='related_comments', to='snippets.snippet', verbose_name='コメントされたスニペット')),
            ],
        ),
    ]
