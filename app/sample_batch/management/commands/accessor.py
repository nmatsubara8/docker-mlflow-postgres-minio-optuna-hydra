...
class MlflowWriter:
    def __init__(self, experiment_name, artifact_location=None, **kwargs):
        ...
        Args:
            experiment_name (_type_): 実験名（system + lpname 名とかにする？）
            artifact_location (_type_, optional): artifactの保存先. ex: s3://<bucket_name>/artifacts Defaults to None.
        """
